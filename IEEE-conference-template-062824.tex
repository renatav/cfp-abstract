...
Coccinelle is a tool widely used to detect and fix issues,
...
maintainers of Coccinelle, we have implemented atoms parsers using Coccinelle.
While our primary focus is on the Linux kernel, Coccinelle can be used to
process any C code. Consequently, the semantic patches we have 
developed for detecting atoms can also be applied to other C 
codebases. We have implemented parsers for the detection of 14
...
academia and industry, we dedicated one of our audience
meetings to Coccinelle. We invited a key contributor to 
Coccinelle to present the tool to our audience, with a 
