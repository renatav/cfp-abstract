...
${}^{\rm ny}$\,New York University \quad ${}^{\rm co}$\,University of Colorado, Colorado Springs  \thanks{This work is supported in part by \yanyan{Justin complete}.}
}
...
post-release defects. \yanyan{Should have a citation here?} Ensuring that software is understandable to 
